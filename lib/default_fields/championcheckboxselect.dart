...
import 'package:championforms/models/field_types/convienence_classes/championcheckboxselect.dart'; // Import the specific field type
import 'package:championforms/models/fieldstate.dart';
import 'package:championforms/models/formresults.dart';
import 'package:championforms/models/multiselect_option.dart';
import 'package:flutter/widgets.dart';

Widget buildChampionCheckboxSelect(
    BuildContext context,
    ChampionFormController controller,
    ChampionCheckboxSelect field, // Use the specific field type
  ...
  return field.fieldBuilder(
    ...
    (MultiselectOption? selectedOption) {
      ...
      if (selectedOption != null) {
        ...
        // Keeping it for consistency with buildChampionOptionSelect pattern.
