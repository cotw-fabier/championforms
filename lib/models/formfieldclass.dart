...
class FormFieldDef implements FormFieldBase {
  ...
  // Use when field is active -- fall back to default when not set
  final FieldColorScheme? activeColorScheme;
  // Use when objects are selected such as checkboxes or switches
  final FieldColorScheme? selectedColorScheme;
  // use when field is in error state -- fall back to default when not set
  final FieldColorScheme? errorColorScheme;
  // Use when field is in disabled state
  final FieldColorScheme? disabledColorScheme;
  // use when field is in default state
